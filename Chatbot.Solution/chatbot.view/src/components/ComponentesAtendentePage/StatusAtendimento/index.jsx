        ...
        <div
            ...
            <div className="mt-2 d-flex  justify-content-center align-items-center rounded-3"
                ...
                <div className="row gap-2 justify-content-center align-items-center ">
                    <div className="col conversaStatus activeOption rounded-2 p-1 text-center"
                        style={{minWidth: "10rem"}}>
                        Ativo</div>
                    <div className="col conversaStatus rounded-2 p-1 text-center" style={{minWidth: "10rem"}}>
                        Esperando</div>
                    <div className="col menuButtonStatus">
